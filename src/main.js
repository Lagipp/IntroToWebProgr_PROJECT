...
class PlayGame extends Phaser.Scene 
{
    ...
    init(params)
    {
        ...
        /* if there's no prior high-score, initializing as 0 */
    ...
    addPipes() 
    {
        /* randomizing from which index the hole starts */
        ...
        if(this.score > 10)
        {
            /* randomizing enemies' spawn points and velocities */
    ...
    /* when colliding with pipes or enemies, changing scenes, stopping music and playing error noise */
